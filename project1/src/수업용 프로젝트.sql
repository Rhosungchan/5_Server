...
-- 비밀번호 암호화
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$J/oPk0L2nNTEwTUmeDZOFOw5FX/.1UdQFhdqE6oXPqAGj25Ib85gu'; 
...
SELECT MEMBER_NO, MEMBER_EMAIL, MEMBER_PW, MEMBER_NICKNAME, MEMBER_TEL,
       MEMBER_ADDRESS, PROFILE_IMG , AUTHOROITY, 
       TO_CHAR(ENROLL_DATE, 'YYYY"년" MM"월" DD"일" HH24"시" MI"분" SS"초"') AS ENPOLL_DATE  
FROM "MEMBER"
WHERE MEMBER_DEL_FL = 'N'
...
INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'user01@kh.or.kr', 'pass01!', '지우지마', '01012345678', '04540,, 서울시 중구 남대문로 120,,2층',
DEFAULT,DEFAULT,DEFAULT,DEFAULT);
COMMIT;
...
-- 중복되는 닉네임 조회
SELECT COUNT(*) FROM "MEMBER"
WHERE MEMBER_NICKNAME = 'user01@kh.or.kr'
AND MEMBER_DEL_FL = 'N';
...
BEGIN
	FOR I IN 1..2000 LOOP
		...
		VALUES(SEQ_BOARD_NO.NEXTVAL,
			   ...
			   DEFAULT,DEFAULT,DEFAULT,DEFAULT,26,CEIL(DBMS_RANDOM.VALUE(0,4)));
	END LOOP;
END;
...
ALTER TABLE PROJECT."COMMENT" MODIFY C_CREATE_DATE DATE DEFAULT SYSDATE;
...
INSERT INTO BOARD_IMG 
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/','20221116105843_00002.gif','2.gif',0,1997);

INSERT INTO BOARD_IMG 
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/','20221116105843_00003.gif','3.gif',0,1993);

INSERT INTO BOARD_IMG 
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/','20221116105843_00004.gif','4.gif',0,1991);


--BOARD_LIKE 테이블 샘플데이터 삽입
SELECT * FROM BOARD_LIKE;

INSERT INTO BOARD_LIKE VALUES(1998,26);
...
TO_CHAR(B_CREATE_DATE,'YYYYY"년" MM"월" DD"일" HH24:MI:SS')B_CREATE_DATE,
TO_CHAR(B_UPDATE_DATE,'YYYYY"년" MM"월" DD"일" HH24:MI:SS')B_UPDATE_DATE,
...
-- 특정 게시글 댓글 모두 조회(어려움)
SELECT COMMENT_NO, COMM--ENT_CONTENT, 
...
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글1', DEFAULT, DEFAULT, 1998, 26, null);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글2', DEFAULT, DEFAULT, 1998, 24, null);

INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글1', DEFAULT, DEFAULT, 1998, 26, 2007);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글2', DEFAULT, DEFAULT, 1998, 26, 2007);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글3', DEFAULT, DEFAULT, 1998, 26, 2007);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글3', DEFAULT, DEFAULT, 1998, 11, 2007);



INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글4', DEFAULT, DEFAULT, 1998, 26, 2008);
INSERT INTO "COMMENT" VALUES(SEQ_COMMENT_NO.NEXTVAL, '대댓글5', DEFAULT, DEFAULT, 1998, 26, 2008);
...
-- INSERT ALL : 한번에 여러 행 삽입 (단, 시퀀스 사용불가)
