...
<body>
    ...
    <!--///////////////////////////////////////////////////////////////////  -->
		...
		<pre> 
			...
			* [ 주의 사항 ]*
			  1) test 속성 값 작성은 무조건 EL구문이여야만 한다.
        ...
        <%-- JSTL 작성법 --%>
        <c:if test="${1==1}"> JSTL 작성법 </c:if>
        

        <%-- session 범위에 세팅된 test의 값이 "session인 경우" --%>
        <%-- 
             - 문자열 비교 시 (==) 비교연산자 사용 가능  
             - 문자열임을 표기하는 리터럴 == ''(홑따음표) / ""(쌍따옴표)
             
             html 태그 속성 = "속성 값" -> 내부 문자열에 ''
             html 태그 속성 = '속성 값' -> 내부 문자열에 ""
    ...
    <!--///////////////////////////////////////////////////////////////////  -->
        ...
        <pre>
            c:choose    : when, otherwise를 감싸는 태그 (현재 태그 내부에 if ~ else if ~ else를 작성하겠다.)
    ...
    <!--///////////////////////////////////////////////////////////////////  -->
		<h1>5. 반복문 ( c:forEach )</h1>

		<pre>
			- 일반 for + 추가 기능
			
			- 속성 
			  1) var   : 현제 반복 횟수에 해당하는 변수 (int i)
			  2) begin : 반복 시 var의 시작 값
			  3) end   : 반복이 종료될 var 값 
			  4) step  : 반복 시 마다 var의 증가 값 (기본 값 : 1)	
