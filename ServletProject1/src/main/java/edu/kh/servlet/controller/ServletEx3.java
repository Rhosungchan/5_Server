...
/* @WebServlet("요청주소")
 * - 헤당 클래스를 Servlet으로 등록하고 (<Servlet> 태그)
 *   + 어떤 요청 주소를 처리할 지 지정(<Servlet-mapping>)의 내용을 
 *     한 번에 작성할 수 있는 어노테이션
 * */

/* 앞으로 이렇게 작성하지 않음 
 * Why.? @WebServlet("/signUp") 어노테이션이 자동 완성 해줌
  <servlet>
...
public class ServletEx3 extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		out.print("<html>");
			out.print("<head></tltle> 회원 가입 결과</title></head>");
